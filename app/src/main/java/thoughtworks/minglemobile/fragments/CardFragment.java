...
import thoughtworks.minglemobile.Service.CardService;
...
public class CardFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String projectId = bundle.getString("projectId", null);

        try {
             allCards = cardService.getAllCards(projectId);
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        card.setTitle("This is where it all begins");
